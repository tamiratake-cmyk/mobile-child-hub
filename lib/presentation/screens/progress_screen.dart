...
class _BadgesGrid extends StatelessWidget {
  ...
  static const allBadges = [
    ...
    {'id': 'memory_starter', 'icon': Icons.psychology_alt_rounded, 'nameEn': 'Memory Starter', 'nameAm': 'የማስታወስ ጀማሪ'},
    {'id': 'memory_master', 'icon': Icons.grid_view_rounded, 'nameEn': 'Memory Master', 'nameAm': 'የማስታወስ ጌታ'},
    {'id': 'game_explorer', 'icon': Icons.stadium_rounded, 'nameEn': 'Game Explorer', 'nameAm': 'ጨዋታ አሳሽ'},
